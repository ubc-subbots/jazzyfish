...
def generate_launch_description():
    ...
    imu = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory('spiderfish_bringup'), 'launch', 'imu_launch.py')
        )
    )

    cameras = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory('spiderfish_bringup'), 'launch', 'cameras_launch.py')
        )
    )
    ...
    ta_config = os.path.join(
        ...
        'config',
        'thruster_config_spiderfish.yaml'
    )
